...
public class EducationalResourceController {
	...
	String resourceDetails[][] = {
			{"A Survival Guide", "file:Resources/images/resource1.jpg", "What to do with your money when crisis hits by Michelle Singletary is the best survival guide you will ever need during a global crisis."},
			{"The Psychology of Money", "file:Resources/images/resource2.jpg", "Timeless lessons about money in form of a book by Morgan Housel. It teaches about wealth, greed, and happiness."},
			{"The Intelligent Investor", "file:Resources/images/resource3.jpg", "A guide to becoming an intelligent investor by Benjamin Graham. he shares his findings in form of a book that is a great start to becoming a great investor."},
			{"Bitcoins and Blockchain", "file:Resources/images/resource4.jpg", "This an introduction to Crytocurrency by Antony Lewis. It covers the basics of bitcoins and blockchain."},
			{"Secrets of the Millionare Mind", "file:Resources/images/resource5.jpg", "A NewYork Times Bestseller by T. Harv Eker. He thinks one should think rick to het rich and writes all the secrets to becoming a millionaire."},
			{"Lords of Finance", "file:Resources/images/resource6.jpg", "An inetresting book written by liaquat ahamed in the 1929 timeline, about depression and how bankers broke the world."}
			};
